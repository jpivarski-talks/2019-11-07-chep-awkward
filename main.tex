...
\begin{center}
\textcolor{blue}{\small \url{https://github.com/jpivarski/PartiQL}}
\end{center}
...
\item<3-> pass to/from a C++ library (e.g.\ jagged array of Lorentz vectors to FastJet),
\item<4-> enter a compiled Numba function for imperative code in Python,
\item<5-> evaluate a declarative expression on sets of particles,
\end{itemize}

\vspace{0.25 cm}
\uncover<6->{interchangeably.}
